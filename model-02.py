import numpy as np
from getdata import load_batch
...
for batch_num in range(0, num_batches):
    ...
    model.fit(x_train, y_train, batch_size=32, epochs=EPOCHS,callbacks=[check],validation_data=(x_test,y_test))
